...
{//Данные форм
    ...
    корректное отображение страницы невозможно.</Р>");
        ...
        //Конект с запросом
        $sql=mysqli_query($connect,"INSERT INTO TEST(`Dogovor`, `Tarif`, `Client`, `Logirovanie`, `LogirZvonkov`, `cmc`, `Internet`) VALUES ('$dog','$ta','$client','$log','$log1','$cmc','$int')"or (mysqli_errno($sql)));
        var_dump($sql);
        if ($sql) {
